...
void RBTree::insert(RBTree::node* target) {
	auto cur = root;
...
void RBTree::fix_insert(RBTree::node* target) {
...
void RBTree::remove(RBTree::node* target) {
	auto cur = target;
...
void RBTree::fix_remove(RBTree::node* target) {
...
void RBTree::transplant(RBTree::node* target, RBTree::node* next) {
	// connect up
...
void RBTree::rotate_left(RBTree::node* target) {
...
void RBTree::rotate_right(RBTree::node* target) {
...
RBTree::node* RBTree::min(RBTree::node* target) {
	while (target->left) {
		target = target->left;
	}
	return target;
...
bool RBTree::is_leaf(RBTree::node* target) {
	return (target->left == nil) && (target->right == nil);
}

void RBTree::destroy(RBTree::node* root) {
	while (root && root != nil) {
		destroy(root->left);
		destroy(root->right);
		delete root;
